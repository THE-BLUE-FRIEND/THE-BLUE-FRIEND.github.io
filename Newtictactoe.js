...
function TictactoeMain()
{
    ...
    for(let i=0;i<size;i++)
    {
        ...
        for(let j=0;j<size;j++)
        {
            ...
            if(i==size-1)
            document.getElementById(`${i}td${j}`).classList.add("down");
            else if(j==size-1)
            document.getElementById(`${i}td${j}`).classList.add("right");
            else
            document.getElementById(`${i}td${j}`).classList.add("all");
            document.getElementById(`${i}td${j}`).addEventListener("click",function()
            {
                if(!end)
                {
                    if(board[i][j]!=' ')
                    ...
                    else
                    {
                        ...
                        {
                            document.getElementById("label").innerText="It was a tie";
                            end=true;
                            return;
                        }
